...
const Events = () => {
  ...
  return (
    <div className='w-full h-auto mb-20'>
      ...
      {/* Event List */}
      <div className="relative w-full flex items-center h-full p-5 overflow-hidden overflow-x-scroll">
        <div
        ...
        {/* Navigation Arrows */}
        <div className="absolute top-1/2 transform -translate-y-1/2 left-0 right-0 px-5 flex justify-between items-center">
          <GoArrowLeft
            onClick={handlePrev}
