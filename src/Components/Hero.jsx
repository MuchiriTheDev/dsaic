    ...
    <div className=' w-full h-fit py-10 sm:py-3 flex sm:flex-row flex-col gap-2 px-5 sm:px-10 items-center justify-center bg-slate-100 '>
        ...
        <div className="w-full h-full flex justify-center items-center">
            <div className="w-full h-fit flex flex-col justify-center sm:justify-start ">
                <h1 className='text-xl md:text-3xl font-semibold  mb-1 text-gray-800'>Revolutionalize with us technology</h1>
                <h1 className='text-xl md:text-3xl font-semibold mb-3 text-green-700 '>at D.S.A.I.C in <span className='font-bold text-green-700 capitalize'>dedan kimathi</span></h1>
